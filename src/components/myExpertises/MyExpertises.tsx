                ...
                <div className={styles.sectionInner}>
                    <div className={`${styles.box} ${styles.boxTop}`}>
                        ...
                        <div className={styles.block2}>
                            <Resume description={"The project includes developing an internal application with the React and Redux frameworks with TypeScript. Responsible for designing and developing interactive UI pages with HTML5, CSS3, SASS and AJAX.Used AJAX & JSON communication against Restful web services. Managed application state using Redux and React.useState Hook. Created small react components to avoid the code redundancy. Implemented single page apps by using routing of React to take the user to various views.Developed the various screens and its architecture in accordance to UI Specs. Wrote extensive JavaScript, HTML and SASS/CSS build dynamic pages using Webstorm.Implemented Jest and Storybook frameworks for unit testing the application. Fixed bugs related to side effects (used React.memo, useCallback, useEffect)."} position={"Front-end Developer"} company={"Google Inc."} period={"May 2020 - Present "}status={'New'}/>
                        </div>
                    </div>
